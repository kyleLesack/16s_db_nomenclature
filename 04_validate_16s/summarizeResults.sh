...
cat 04_validate_16s/results/gg/gg_unclassified_genera.csv | cut -d "," -f2 | sort | uniq -c | sort -nr | head -n 10  > 04_validate_16s/results/gg/summaries/gg_unclassified_genera_topten.txt
...
cat 04_validate_16s/results/gg/gg_unclassified_species.csv | cut -d "," -f2 | sort | uniq -c | sort -nr | head -n 10  > 04_validate_16s/results/gg/summaries/gg_unclassified_species_topten.txt
...
cat 04_validate_16s/results/rdp/rdp_unclassified_genera.csv | cut -d "," -f2 | sort | uniq -c | sort -nr | head -n 10  > 04_validate_16s/results/rdp/summaries/rdp_unclassified_genera_topten.txt
...
cat 04_validate_16s/results/silva/silva_unclassified_genera.csv | cut -d ";" -f2 | sort | uniq -c | sort -nr | head -n 10  > 04_validate_16s/results/silva/summaries/silva_unclassified_genera_topten.txt
...
cat 04_validate_16s/results/silva/silva_unclassified_species.csv | cut -d ";" -f2 | sort | uniq -c | sort -nr | head -n 10  > 04_validate_16s/results/silva/summaries/silva_unclassified_species_topten.txt
